...
# steered
python features_intervention.py --model_name Llama-3.2-1B --extracting_from mmlu-pro_600 --device "cuda:1" --Intervention True > ../../outputs/Llama-3.2-1B_test_on_MMLU600.log