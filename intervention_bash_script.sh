...
# CoT unsteered
python features_intervention.py --model_name DeepSeek-R1-Distill-Qwen-1.5B --extracting_from mmlu-pro_600 --device "cuda:1"> ../../outputs/DeepSeek-R1-Distill-Qwen-1.5B_test_on_MMLU600.log
